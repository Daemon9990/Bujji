...
# Bot Admins
ADMINS = environ.get('ADMINS', '6890795853 809614790 5226707402 5107391815') #apni tg id daalo
if len(ADMINS) == 0:
...
URL = environ.get("URL", "https://bujji-iibg.onrender.com/") #if heroku then paste the app link here ex: https://heroku......./
if len(URL) == 0:
    ...
    if URL.startswith(('https://', 'http://')):
        ...
        URL = f'https://bujji-iibg.onrender.com/'
    else:
